...
[中文说明](README.zh-CN.md) · Creation examples: [Original conversation (Chinese)](examples/aesthetic-seed-creation-example.pdf) · [English adaptation](examples/aesthetic-seed-creation-example-en.pdf)
...
📖 Creation examples: [Original conversation (Chinese PDF)](examples/aesthetic-seed-creation-example.pdf) · [English adaptation](examples/aesthetic-seed-creation-example-en.pdf)
